...
namespace GSLanguageCompiler {
     ...
     * @return Note message
     */
    inline IO::GS_Message operator""_note(const char *text, U64 size) {
     ...
     */
    inline IO::GS_Message operator""_warn(const char *text, U64 size) {
        return IO::GS_MessageBuilder::Create().Text(UString(text))
                                              .Warning()
                                              .Message();
    }
     ...
     */
    inline IO::GS_Message operator""_err(const char *text, U64 size) {
        return IO::GS_MessageBuilder::Create().Text(UString(text))
                                              .Error()
                                              .Message();
    }
     ...
     */
    inline IO::GS_Message operator""_fatal(const char *text, U64 size) {
        return IO::GS_MessageBuilder::Create().Text(UString(text))
                                              .Fatal()
                                              .Message();
    }
