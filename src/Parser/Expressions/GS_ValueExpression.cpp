...
//    }
    ...
    std::string GS_ValueExpression::generateCode() {
        ...
        if (type == "Int") {
            ...
            throw Exceptions::GS_Exception("Generating code for string types not supported!");
        } else {
            throw Exceptions::GS_Exception("Generating code for null types not supported!");
        }
    }
